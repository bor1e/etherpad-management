...
exports.expressCreateServer = function (hook_name, args, cb) {
  //eingelade User Hinzufuegen
	...
	//			log('debug','add user ' + addUserQuery);
      ...
      function(req, res){
        getUserUid(req.user.uid, function(found, currUser){
          if(found){
            ...
            req.session.baseurl = 'https://etherpad.rrze.uni-erlangen.de/';
           	res.redirect('/');
						return true;
					}	else { 
  ...
  args.app.get('/iframe.html', function (req, res) {
    userAuthenticated(req, function (authenticated) {
      if (authenticated) {
        getUser(req.session.userId, function (found, currUser) {
          var render_args;
            if (currUser && currUser.length > 0) {
              ...
              res.send(eejs.require("ep_user_pad_frontend/templates/iframe.ejs", render_args));
            } else {
              render_args = {
                errors: [],
                username: ""
