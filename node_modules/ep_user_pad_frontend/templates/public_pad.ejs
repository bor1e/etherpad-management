    ...
    <body>
    	<div id="wrapper">
    		 <header style="height:50px">
    		 	<div class="inside">
  		 		<img src="./../../../static/plugins/ep_user_pad_frontend/static/images/logo_rrze.gif" alt="Etherpad" class="leftArea" style="height:37px; width:100px; padding:5px 0% 0% 0%;">
    		 	    <nav id="sekMenu">
	    		 		<ul>
    		 				<!--li><a lang="en" id="register">Register</a></li-->
    		 				<!--li class="separator">|</li-->
    		 				<li><a href="https://etherpad.rrze.uni-erlangen.de/login" lang="en" id = "login">Login</a></li>
    		 			</ul>
	    		 	</nav> 
    		 	   	<!--nav id="mainMenu">
	    		 		<ul>
    		 ...
    		 <div id="main" >
       		 	<div class="inside">
       		 	    <iframe src="./<%= padurl %>" width="100%" id="iframePad"></iframe>
       		 	</div>
       		 </div> 
       		 	
       		 <footer>
       		 	<div class="inside">
       		 		<p lang="en"><a href="./../../../imprint.html">Impressum</a></p>
       		 	</div>
       		 </footer>
