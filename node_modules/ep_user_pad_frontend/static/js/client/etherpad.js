...
//						console.log('here');
	...
	$('#search').keyup(function(){
		/// search
    	$(".inputBlock table tbody tr").each(function(){
...
//			console.log(url);
			post(data, url+'createGroup' ,function(data){
				if(!data.success){
					...
					console.log(data);
					/*var gruppenname = $("#groupName").val();
					var gruppenid = data.groupid;
					$("#mymodal").find('.modal-header span').empty().append(gruppenname + ' - Benutzerverwaltung');
					$("#mymodal").find('.modal-body').empty().append(
'F&uuml;ge Benutzer hinzu'+'<br/>'+'<br/>'+
'<form class="input-group" id="selUsersForm">'+
'<input class="form-control" type="text" placeholder="Email" id="selectedUsers" autocomplete=off>'+
'<div class="input-group-btn">'+
'<button type="submit" class="btn btn-primary" id="invitebtn">'+
'<span class="glyphicon glyphicon-arrow-right"></span></button>'+
'</div> <!-- /.input-group-btn -->'+
'</form>'+
'<span class="text-info"> Mehrere Benutzer durch \';\' trennen</span>'
);
...
/*					$("#mymodal").find('.modal-header span').empty().append('Benutzer: ' + users[0] + ' erfolgreich hinzuge&uuml;gt');
...
//			console.log("heraöjdfö");
			...
			data.padName = data.padName.replace(new RegExp('/','g'), '_');
			console.log("\n\n_frontend/static/js/client/etherpad.js:1232\t HERE WE GO\n\n"+ data.padName);
